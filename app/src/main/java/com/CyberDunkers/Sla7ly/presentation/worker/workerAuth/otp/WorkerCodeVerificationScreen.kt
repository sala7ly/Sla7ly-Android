...
@Destination
@Composable
fun WorkerCodeVerificationScreen(
            ...
            if (state.data.msg != "false") {
                ...
                state.data.let {
                    if (state.data.msg == "old user") {
                        navigator.navigate(
                            WorkerHomeScreenDestination()
                        ){
                            popUpTo(WorkerCodeVerificationScreenDestination.route){
                                inclusive = true
                            }
                        }
                    } else {
                        navigator.navigate(
                            WorkerDataScreenDestination(
            ...
            Column(
                ...
                BackBtn(
                    onClick = {
                        navigator.navigate(WorkerEnterPhoneScreenDestination) {
                            popUpTo(WorkerEnterPhoneScreenDestination.route) {
                                inclusive = true
                            }
                        }
                    }, modifier = Modifier
                ...
                Box(
                    ...
                    PinView(
                        ...
                        type = Constants.PIN_VIEW_TYPE_UNDERLINE,
                        containerSize = 60.dp
                    )
